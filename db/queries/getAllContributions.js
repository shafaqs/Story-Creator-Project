 ...
 */
 const getAllContributions = function(story_id, limit = 10) {
  return db.query(`SELECT stories.id as id, name as contributor_name, contributions.content as content, array_length(upvote_users, 1) as upvote_count, contributions.id as contribution_id
            FROM stories
